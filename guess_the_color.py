...
######################### GUI #########################
labelHeader = Label(root, text='GUESS THE COLOR', fg='orange', font=headerFont)
labelScore = Label(root, text=str(scoreDefaultText), font=standartFont)
labelTimer = Label(root, text=('time: ' + str(counter)), font=standartFont)
labelCommand = Label(root, text='Guess the color:')
labelColor = Label(root, text='', fg=randomColor, bg='white', font=colorFont, width=10, relief=GROOVE, borderwidth=2)
labelResult = Label(root, text='', font=standartFont, bg='white')
entryField = Entry(root, font=('Consolas',13))
inputButton = Button(root, text='Start', width=10, bg='lavender', command=start, relief=RIDGE, borderwidth=1)
buttonC1 = Button(root, text='', font=standartFont, bg='linen', width=12, height=1, relief=RIDGE, borderwidth=1, state=DISABLED)
buttonC2 = Button(root, text='', font=standartFont, bg='linen', width=12, height=1, relief=RIDGE, borderwidth=1, state=DISABLED)
buttonC3 = Button(root, text='', font=standartFont, bg='linen', width=12, height=1, relief=RIDGE, borderwidth=1, state=DISABLED)
